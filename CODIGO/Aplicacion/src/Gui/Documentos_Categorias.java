 ...
 * @author Smart
 */
public class Documentos_Categorias extends javax.swing.JFrame {
    ...
    ArrayList listdois = new ArrayList();
    ...
    ArrayList<Documentos> listdoi = null;
    ArrayList<Keywords> listkeys = null;

    public Documentos_Categorias() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 60, 250, -1));
        ...
        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 270, 550, 250));

        pack();
    }// </editor-fold>//GEN-END:initComponents
    Object columnas[] = {"Documentos"};
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(Documentos_Categorias.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void Listar() throws ClassNotFoundException, SQLException {
        ...
        for (int i = 0; i < ale.size(); i++) {
            ...
            lstkeys = blkey.ConsultaLista2(keyword);
//            System.out.println("palabra" + lstkeys);
        ...
        for (int i = 0; i < list.size(); i++) {
            String paperdoi = (String) list.get(i);
            document.setDoi(paperdoi);
            lstestudiante = bldocument.ConsultaLista2(document);
          
            for (Documentos document : lstestudiante) {
                String papers = "'" + document.getDocumento() + "'";

                listdocumentos.add(papers);
            }

        }
        listdocumentos=(ArrayList) listdocumentos.stream().distinct().collect(Collectors.toList());
         Collections.sort(listdocumentos);
        for (int i = 0; i < listdocumentos.size(); i++) {
            String nombres = (String) listdocumentos.get(i);
    ...
    public void Listarkeys() throws ClassNotFoundException, SQLException {
        String dato = String.valueOf(modelo.getValueAt(jTable1.getSelectedRow(), 0));

        System.out.println(dato);
        document.setDocumento(dato);
        listdoi = bldocument.ConsultaListaDoi(document);

        listdois.clear();
        for (Documentos sujetosskos : listdoi) {
            String suketoskos = "'" + sujetosskos.getDoi() + "'";
            listdois.add(suketoskos);
            System.out.println("listas" + listdois);
            lstkeys.clear();
        }

        for (int i = 0; i < listdois.size(); i++) {
            String keywords = (String) listdois.get(i);
            keyword.setDoi(keywords);
            listkey.clear();
            lstkeys = blkey.ConsultaListaKeyes(keyword);

            for (Keywords sujetodbp : lstkeys) {
                String doises = "'" + sujetodbp.getPalabra() + "'";
     ...
     Collections.sort(listkey);
        for (int i = 0; i < listkey.size(); i++) {
            ...
            System.out.println(listkey.get(i));
            this.jTextArea1.setText(this.jTextArea1.getText()  + listkey.get(i)+ "\n");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Documentos_Categorias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Documentos_Categorias().setVisible(true);
            }
        });
    }
